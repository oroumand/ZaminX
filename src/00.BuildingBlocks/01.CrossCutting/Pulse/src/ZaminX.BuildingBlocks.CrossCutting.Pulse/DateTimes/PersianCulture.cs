...
public static class PersianCulture
{
    ...
    public static string GetPersianMonthDayNumberName(this int dayNumber)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(dayNumber), dayNumber, "dayNumber must be between 1 and 31.");
        }
    ...
    public static string GetPersianMonthName(this int monthNumber)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(monthNumber), monthNumber, "monthNumber must be between 1 and 12.");
        }
    ...
    public static int GetPersianMonthLastDay(this int persianYear, int persianMonth)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(persianMonth), persianMonth, "ماه وارد شده معتبر نیست.");
        }
